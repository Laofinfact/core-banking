...
export interface WCLoanProductTemplate {
  ...
  breachOptions?: Array<{ id: number; name: string }>;
  nearBreachOptions?: Array<{ id: number; name: string }>;
  delinquencyStartTypeOptions?: Array<{ id: number; code: string; value: string }>;
  breachStartTypeOptions?: Array<{ id: number; code: string; value: string }>;
  delinquencyMinimumPaymentTypeOptions?: Array<{ id: number; code: string; value: string }>;
  ...
  chargeOptions?: Array<{ id: number; name: string }>;
  penaltyOptions?: Array<{ id: number; name: string }>;
